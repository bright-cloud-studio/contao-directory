...
class ListingsBackend extends \Backend
{
    ...
    public function getProfessions() {
        return array(
            ...
            'Physician, neurologist' => 'Physician, neurologist',
            'Physician, other specialty' => 'Physician, other specialty',
            ...
            'Licensed counselor (LCPC, LMHC, etc.)' => 'Licensed counselor (LCPC, LMHC, etc.)',
